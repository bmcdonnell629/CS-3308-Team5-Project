...
cmd line usage ./wordScript.py <letters> <# of free letters>
app usage free_letter_wordScript.main('scriptName', <letters>, <# of free letters>)
'''
import sys
...
def main(scriptName, letters, freeTiles):
    '''
    main function for script
    takes 3 inputs: string of script name, string of letter input, int # of of free letters
    returns dictionary wit key of possible scrabble words from letter input and free tiles and values of scrabble scores
    '''
    #empty letter list 
    letterList = []
    #check length of command line arg
    if len(sys.argv) != 3:
        print("Incorrect Usage: ", scriptName, " <letter input> <# of free letters>")
        sys.exit()
    ...
    try:
        ...
        print("Incorrect Usage: ", scriptName, " <letter input> <# of blank tiles>")
        sys.exit()
